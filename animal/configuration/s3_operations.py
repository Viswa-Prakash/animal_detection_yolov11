...
class S3Operation:
    ...
    def download_object(self,key, bucket_name, filename):
        ...
        Inputs:     S3 object key, bucket_name, local filename.
        Action:     Downloads the object from the specified bucket and saves it locally.
        """
    ...
    def read_object(
        ...
        Inputs:     S3 object, flags to decode as text and/or convert to readable stream.
        Output:     Returns either the raw content or a StringIO stream.
        Use Case:   Useful for reading model/data files from memory rather than saving them locally.
        """
    ...
    def get_file_object(
        ...
        """
        Gets S3 object(s) matching the specified filename.
    ...
    def upload_file(
        ...
        Output      :   Folder is created in s3 bucket
        Behavior    :   Uploads the file and optionally deletes the local copy.
        """
    ...
    def upload_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        Description :   This method uploads the from_filename file to bucket_name bucket with to_filename as bucket filename
        Output      :   Folder is created in s3 bucket
        Behavior    :   Iterates through folder and uploads each file individually.
        """
    ...
    def upload_df_as_csv(
        ...
        Output      :   Folder is created in s3 bucket
        Behavior    :   Saves the DataFrame locally as CSV and uploads it.
        """
    ...
    def get_df_from_object(self, object_: object) -> DataFrame:
        ...
        """
        Reads a CSV object from S3 into a DataFrame.
        Method Name :   get_df_from_object
        Description :   This method gets the dataframe from the object_name object 
        Output      :   pandas.DataFrame
        Behavior    :   Converts the file content into a DataFrame using read_csv.
        """
    ...
    def read_csv(self, filename: str, bucket_name: str) -> DataFrame:
        ...
        """
        Wrapper to directly read a CSV file from S3 into a DataFrame.
        Method Name :   read_csv
        Description :   Fetches the object using filename and then loads it into a DataFrame. 
        Output      :   pandas.DataFrame
